...
INSERT INTO client VALUES ('1234567L', 'Roger', 'Marin', 655656566, 'rmarin@gmail.com', 'H', '2003-9-5', 'rmarin', '1234', '1234567B', '', false);

INSERT INTO activitat VALUES (default, 'Body pump', '', 'vermell', 60),
	(default, 'Cycling', '', 'vermell', 45),
    (default, 'Zumba', '', 'blau',  30),
    (default, 'Pilates', '', 'blau',  30),
    (default, 'Yoga', '', 'taronja',  45),
    (default, 'Body Combat', '', 'verd',  45),
    (default, 'Crossfit', '', 'taronja',  60),
    (default, 'Body balance', '', 'verd',  60);
...
INSERT INTO reserva_lliure VALUES ('2022-3-1', '16:30:00', null, '1234567L', '2');

INSERT INTO reserva_colectiva VALUES ('2022-3-1', '16:30:00', null, '1234567L', '1');
